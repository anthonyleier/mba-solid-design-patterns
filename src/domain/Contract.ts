...
export default class Contract {
    ...
    constructor(readonly idContract: string, readonly description: string, readonly amount: number, readonly periods: number, readonly date: Date) {
        this.payments = [];
    }
    ...
    getBalance() {
        ...
        for (const payment of this.payments) balance -= payment.amount;
        return balance;
    }
